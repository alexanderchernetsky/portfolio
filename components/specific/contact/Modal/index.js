...
const ModalComponent = ({title, visible, onCloseHandler, children, isFooter}) => {
    ...
    return (
        <ModalBackground visible={visible} onClick={backgroundClickHandler} id="modal_background_id">
            <ModalWindow>
                <Close onClick={onCloseHandler} tabIndex={0} onKeyPress={onCloseHandler}>
