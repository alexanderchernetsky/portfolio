...
const Contacts = () => {
    ...
    const {fullName, fullNameError, email, emailError, message, messageError, isSubmitting, isSuccessModalVisible, isErrorModalVisible} = state;
    ...
    return (
        <Layout>
            <Head>
                ...
                <meta name="description" content="Contact Alexander Chernetsky. Ask questions or hire a frontend web developer." />
            ...
            <ContactPageWrapper id="contact-page">
                <ContentWrapper>
                    ...
                    <Form onSubmit={handleSubmit} method="post" enctype="multipart/form-data">
                        ...
                        {/* Submit btn */}
                        <ButtonsWrapper>
                            <ButtonComponent text="Submit" colorTheme="green" type="submit" disabled={isSubmitting} loading={isSubmitting} />
                        </ButtonsWrapper>
                    ...
                    <Footer>
                        <SocIconsWrapper>
                            {socIcons.map((item, index) => {
                                return <SocIconComponent iconSrc={item.src} iconName={item.name} linkTo={item.linkTo} key={index} />;
                            })}
                        </SocIconsWrapper>
                        <Footnote>
